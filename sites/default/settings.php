...
$settings['hash_salt'] = 'ZGVmYXVsdAA5AwAAAAAAAKBzvirMWwAARwMAAA==';
/**
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_phtn_buzzrx_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_phtn_buzzrx_dd.inc';
}
// </DDSETTINGS>
